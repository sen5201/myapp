 ...
 * the License.
 */
package com.denali.app.generator;
 ...
 * @since 2018-11-01
 */
public class MysqlGenerator extends GeneratorCommon {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
            ...
            new DataSourceConfig()
                ...
                .setUsername("root")
                .setPassword("123456")
                .setUrl("jdbc:mysql://10.1.52.26:3306/audit?useUnicode=true&allowPublicKeyRetrieval=true&useSSL=false&characterEncoding=utf8")
        ).setStrategy(
            // 策略配置
            new StrategyConfig()
